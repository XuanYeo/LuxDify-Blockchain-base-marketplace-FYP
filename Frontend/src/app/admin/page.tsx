    ...
    <div>
      ...
      <div className="home-container">
        ...
        <section className="quick-actions section">
          <Link href="/admin/token_reload" className="quick-action-btn">🔄 Purchase Tokens Request</Link>
        </section>
        ...
        <section className="popular-products-section section">
          ...
          <div className="product-grid">
            {popularProducts.length === 0 ? (
              ...
              popularProducts.map((product: any) => (
                <Link href={`/admin/product/${product.Product_ID}`} key={product.Product_ID} className="product-card glow">
          ...
          <div className="explore-more-wrapper">
            <Link href="/admin/collection" className="explore-more-btn">
              🌟 Explore More
            </Link>
          </div>
        </section>
